...
export const GOLD_PRODUCTS = [
  ...
  { id: "Gold Set1", name: "Necklace", price: 96000, category: "Necklaces", purity: "22K", weight: "28.3 g", stones: "Floral Motif • Pear-Cut Diamonds • Gold Accents • Intricate Craftsmanship", description: "A stunning diamond jewellery set featuring an intricate floral-inspired design with elegant gold detailing and sparkling pear-cut diamonds. The matching necklace, earrings, and ring create a luxurious, graceful look perfect for special occasions.", images: [goldSet4, goldSet5, goldSet6] },
  { id: "Gold Set2", name: "Necklace", price: 96000, category: "Necklaces", purity: "22K", weight: "28.3 g", stones: "Floral Diamond Motifs, Teardrop Accents, Intricate Goldwork", description: "A delicate diamond necklace adorned with floral-inspired motifs and a graceful teardrop pendant. Matching earrings and a statement ring complete this elegant, nature-inspired jewellery set.", images: [goldSet7, goldSet8, goldSet9] },
...
export const SILVER_PRODUCTS = [
  ...
  { id: "silver-earrings1", name: "Earrings", price: 1800, category: "Earrings", purity: "92.5 Sterling", weight: "2.6 g (pair)", stones: "Pink Floral, Emerald Green, Gold Finish, Stone Embellishments", description: "Beautiful floral stud earrings featuring a delicate pink centre surrounded by emerald-green petals and sparkling stone accents. Their vibrant colours and intricate craftsmanship add a graceful, traditional charm.", images: [silverEaring7, silverEaring8, silverEaring9] },
